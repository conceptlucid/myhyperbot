    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: 'system-ui' }}>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '40px 20px', background: 'radial-gradient(ellipse at top, #1a1a3e 0%, #0a0a0a 70%)' }}>
        ...
        <div style={{ display: 'flex', gap: '15px', marginBottom: '50px', flexWrap: 'wrap', justifyContent: 'center' }}>
          <Link href="/dashboard" style={{ padding: '16px 32px', background: '#00d4ff', color: '#000', borderRadius: '12px', fontWeight: '600', textDecoration: 'none', fontSize: '1rem' }}>
            Try Now →
          </Link>
          <Link href="/download" style={{ padding: '16px 32px', background: 'transparent', border: '1px solid #333', color: '#fff', borderRadius: '12px', textDecoration: 'none', fontSize: '1rem' }}>
            Install
          </Link>
        </div>
        ...
        <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center', maxWidth: '800px' }}>
          {[
            ...
            <div key={i} style={{ padding: '25px', background: '#111', borderRadius: '16px', width: '220px' }}>
      ...
      <section style={{ padding: '80px 20px', maxWidth: '700px', margin: '0 auto' }}>
        ...
        <div style={{ background: '#111', borderRadius: '16px', padding: '30px', border: '1px solid #222' }}>
          <div style={{ marginBottom: '20px' }}>
            <span style={{ color: '#888', fontSize: '0.85rem' }}>You</span>
            <div style={{ background: '#00d4ff', color: '#000', padding: '12px 16px', borderRadius: '12px 12px 12px 0', marginTop: '8px', display: 'inline-block' }}>
          ...
          <div>
            ...
            <div style={{ background: '#111', color: '#fff', padding: '12px 16px', borderRadius: '12px', marginTop: '8px', border: '1px solid #333' }}>
